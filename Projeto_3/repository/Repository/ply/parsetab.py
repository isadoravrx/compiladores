...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','parser.py',7),
  ('expression -> expression MINUS term','expression',3,'p_expression','parser.py',8),
  ('expression -> term','expression',1,'p_expression','parser.py',9),
  ('term -> term TIMES factor','term',3,'p_term','parser.py',21),
  ('term -> term DIVIDE factor','term',3,'p_term','parser.py',22),
  ('term -> factor','term',1,'p_term','parser.py',23),
  ('factor -> NUMBER','factor',1,'p_factor','parser.py',35),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','parser.py',36),
]
